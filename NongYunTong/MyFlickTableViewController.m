...
#import "MyFlickTableViewController.h"

@implementation MyFlickTableViewController
...
- (void)loadView {
	...
	UITableView* tableView = [[UITableView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.view.frame.size.width, self.view.frame.size.height) style:UITableViewStyleGrouped];
	...
	MyFlickTabView* aFlickTabView = [[MyFlickTabView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.view.frame.size.width, 43.0f)];
	...
	leftCap.image = [UIImage imageNamed:@"flick-fade-lt2.png"];
	...
	rightCap.image = [UIImage imageNamed:@"flick-fade-rt2.png"];
